...
public class Admin_EconomicaMain extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Admin_EconomicaMain(MySQLConnection connection, String userDni) {
		...
		LeftMenuButton economicManageBtn = new LeftMenuButton("Gestión económica",true);
		...
		JLabel lblTabName = new JLabel("Gestión económica");
		...
		MainButton doctoresBtn = new MainButton("Doctores");
		doctoresBtn.setEnabled(false);
		doctoresBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Menu_Controller.openConsDoc(connection, userDni);
				dispose();
			}
		});
		doctoresBtn.setBounds(386, 270, 310, 44);
		centeredPanel.add(doctoresBtn);
		
		MainButton pacientesBtn = new MainButton("Pacientes");
		pacientesBtn.setEnabled(false);
		pacientesBtn.setBounds(386, 324, 310, 44);
		centeredPanel.add(pacientesBtn);
