CREATE DATABASE  IF NOT EXISTS `dentiapp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dentiapp`;
...
CREATE TABLE `dientes` (
  ...
  PRIMARY KEY (`id_cita`,`num_diente`),
  KEY `dientes_ibfk_1_idx` (`id_cita`) /*!80000 INVISIBLE */,
  CONSTRAINT `dientes_ibfk_1` FOREIGN KEY (`id_cita`) REFERENCES `citas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos_productos` (
  ...
  KEY `pedidos_productos_ibfk_2_idx` (`id_producto`),
...
CREATE TABLE `productos` (
  ...
  `baja` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `productos_ibfk_1_idx` (`nif_proveedor`),
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`nif_proveedor`) REFERENCES `proveedores` (`nif`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-01-13 13:53:41
